...
| ---- | ----------- | ----------- | ---- | ---- | ---------- |
| TR_1 | IFTA_QA_001 | A large volume of aircraft data is received by the ADS-B server in a short period of time.            |   4   |  5   |   20     |
...
| TR_5 | IFTA_QA_007 | Large playback data size.            |  4   |  3   |    12       |
| TR_6 | IFTA_QA_008 | User configuration may become invalid if it hasn't been saved for a long time.          |  3   |   2  |     6     |
...
| TR_5 | Large playback data size            |    Mid     | limit recoding file size             | [Exp 5](./Experiments/exp05.md) |
| TR_6 | User configuration may become invalid if it hasn't been saved for a long time.        |    Low     | Perform a validation check on the configuration values and provide default data if they are invalid.                   |                    |
