...
| TR_5 | IFTA_QA_005 | The map provider may need API key |  3   |  2   |     6     |
| TR_6 | IFTA_QA_007 | Large playback data size.            |  4   |  3   |    12       |
| TR_7 | IFTA_QA_008 | User configuration may become invalid if it hasn't been saved for a long time.          |  3   |   2  |     6     |
